...
namespace XLua.CSObjectWrap
{
    ...
    public class LuaInterfaceWrap
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginObjectRegister(typeof(LuaInterface), L, translator, 0, 0, 0, 0);
			
			
			
			
			
			Utils.EndObjectRegister(typeof(LuaInterface), L, translator, null, null,
			    null, null, null);

		    Utils.BeginClassRegister(typeof(LuaInterface), L, __CreateInstance, 7, 0, 0);
			Utils.RegisterFunc(L, Utils.CLS_IDX, "SetScale", _m_SetScale_xlua_st_);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "SetRotationByEuler", _m_SetRotationByEuler_xlua_st_);
            ...
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "UnderlyingSystemType", typeof(LuaInterface));
			
			
			Utils.EndClassRegister(typeof(LuaInterface), L, translator);
        }
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					LuaInterface __cl_gen_ret = new LuaInterface();
        ...
        static int _m_SetScale_xlua_st_(RealStatePtr L)
        {
            ...
            try {
                if(__gen_param_count == 4&& translator.Assignable<UnityEngine.GameObject>(L, 1)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 4)) 
                {
                    ...
                    LuaInterface.SetScale( go, x, y, z );
                ...
                if(__gen_param_count == 4&& translator.Assignable<UnityEngine.Transform>(L, 1)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 4)) 
                {
                    ...
                    LuaInterface.SetScale( trans, x, y, z );
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to LuaInterface.SetScale!");
            
        }
        
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_SetRotationByEuler_xlua_st_(RealStatePtr L)
        {
            ...
            try {
                if(__gen_param_count == 4&& translator.Assignable<UnityEngine.GameObject>(L, 1)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 4)) 
                {
                    ...
                    LuaInterface.SetRotationByEuler( go, x, y, z );
                ...
                if(__gen_param_count == 4&& translator.Assignable<UnityEngine.Transform>(L, 1)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 4)) 
                {
                    ...
                    LuaInterface.SetRotationByEuler( trans, x, y, z );
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to LuaInterface.SetRotationByEuler!");
        ...
        static int _m_SetPosition_xlua_st_(RealStatePtr L)
        {
            ...
            try {
                if(__gen_param_count == 4&& translator.Assignable<UnityEngine.GameObject>(L, 1)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 4)) 
                {
                    ...
                    LuaInterface.SetPosition( go, x, y, z );
                ...
                if(__gen_param_count == 4&& translator.Assignable<UnityEngine.Transform>(L, 1)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 4)) 
                {
                    ...
                    LuaInterface.SetPosition( trans, x, y, z );
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to LuaInterface.SetPosition!");
        ...
        static int _m_PlayAnimation_xlua_st_(RealStatePtr L)
        {
            ...
            try {
                
                {
                    ...
                    LuaInterface.PlayAnimation( go, name );
